...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='planilla',
            name='acciones',
            field=models.TextField(blank=True, null=True, verbose_name='Acciones inmediatas'),
        ),
        migrations.AlterField(
            model_name='planilla',
            name='comentarios',
        ...
        migrations.AlterField(
            model_name='planilla',
            name='verificacion',
            field=models.CharField(blank=True, null=True, verbose_name='Verificación de las acciones tomadas'),
        ),
    ]
